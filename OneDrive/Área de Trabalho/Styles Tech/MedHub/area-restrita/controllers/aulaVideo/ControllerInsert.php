...
if ($SendCadImg) {
    ...
    $usuario = filter_input(INPUT_POST, 'usuario_id', FILTER_SANITIZE_STRING); 

    $nome_arq_webm = $base . "." . $ext;
    //var_dump($_FILES['imagem']);
    //Inserir no BD
    $result_img = "INSERT INTO aula_vid (nome_vid, aula_id_vid, arq_vid, usuario_id) VALUES (:nome_vid, :aula_id_vid, :arq_vid, :usuario_id)";
    ...
    $insert_msg->bindParam(':usuario_id', $usuario);
