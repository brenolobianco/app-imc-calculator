<?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        $insert = "INSERT into aula ( nome_aula, desc_aula, curso_id_aula, mod_id_aula, est_id_aula, prof_id_aula, usuario_id) 
        VALUES ( :nome_aula, :desc_aula, :curso_id_aula, :mod_id_aula, :est_id_aula, :prof_id_aula, :usuario_id)";  
        if($treinamento == "sim") {
            $insert = "INSERT INTO aula (nome_aula, desc_aula, mod_id_aula, est_id_aula, prof_id_aula, treinamento, cronograma_semanas, taxa_acerto_quiz, usuario_id) 
            VALUES ( :nome_aula, :desc_aula, :mod_id_aula, :est_id_aula, :prof_id_aula, :treinamento, :cronograma_semanas, :taxa_acerto_quiz, :usuario_id)";
        }
            try{
