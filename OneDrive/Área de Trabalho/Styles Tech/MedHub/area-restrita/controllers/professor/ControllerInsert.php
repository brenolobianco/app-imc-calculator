<?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        $usuario = trim(strip_tags($_POST["usuario_id"]));   
            ...
            $insert = "INSERT into professor ( nome_prof, email_prof, whats_prof, link_cv_lates_prof, desc_prof, usuario_id ) 
            VALUES ( :nome_prof, :email_prof, :whats_prof,:link_cv_lates_prof, :desc_prof, :usuario_id )";  
        try{
