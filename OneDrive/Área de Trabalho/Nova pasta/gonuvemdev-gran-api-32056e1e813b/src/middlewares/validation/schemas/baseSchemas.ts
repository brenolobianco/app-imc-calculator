...
export const stringEnumSchema = (stringEnum: MyObject): Joi.StringSchema => {
  return Joi.string()
    .strict()
    .valid(...Object.values(stringEnum));
};
...
export const digitsStringSchema = basicStringSchema.regex(/^[0-9]+$/);
...
export const dateIntervalSchema = Joi.object().keys({
...
export const createSchema = (input: Joi.ObjectSchema): Joi.ObjectSchema => {
...
export const listSchema = (
  ...
  return Joi.object({
    q: basicStringSchema.max(100).optional(),
...
export const updateSchema = (input: Joi.ObjectSchema): Joi.ObjectSchema => {
