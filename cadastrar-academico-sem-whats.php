	    ...
	    <div class="row justify-content-center align-items-center">
            ...
            <form action="#" method="post">
                  ...
                  <div class="form-group form_espaco">
                    <input type="text" class="place_form form-control" name="email_acad" placeholder="Email *" required>
                  </div>
                  <div class="form-group form_espaco">
                ...
                <div class="form-row form_espaco">
                  ...
                  <div class="form-group form_espaco">
                    <input type="text" class="place_form  form-control" name="link_cv_lates_acad" placeholder="Link CV Lattes">
                  </div>
                  <div class="form-row">  
