                ...
                if($error != 0)
                    ...
                    if(move_uploaded_file($tmp, $folder.'/'.$novoNome)){
                        //$msg[] = "<b>$name :</b> Upload Realizado com Sucesso!";
                            $insert = "INSERT into hospital ( nome_hosp, fone_hosp, resp_hosp, email_hosp, senha_hosp, cep_hosp, uf_hosp, cidade_hosp, bairro_hosp, rua_hosp, num_hosp, img_hosp ) 
                            VALUES ( :nome_hosp, :fone_hosp, :resp_hosp, :email_hosp, :senha_hosp, :cep_hosp, :uf_hosp, :cidade_hosp, :bairro_hosp, :rua_hosp, :num_hosp, :img_hosp )";  
                        try{
