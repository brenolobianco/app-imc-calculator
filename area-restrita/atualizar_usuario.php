...
// Agora eu acho que isso resolva remodificarr a pagina já pronta. blz

function select($id) {
    /**
     * 
     * Selecione os dados do usuario e mostre na tela sinalizando que está havendo alguma atualização
     * 
...
<head>
    ...
    <title>MedHub - Atualizar usuário</title>
</head>

<body>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous">
    <?php include 'controllers/areaGestor/ControllerUpdate.php'; ?>
        ...
        <div class="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card-box">
                            <h2 class="mt-0 mb-3 header-title">Atualizar de Novo Setor</h2>
