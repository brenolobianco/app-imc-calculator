        ...
        <div class="row position-static ">
            ...
            <button type="button" class="btn btn btn-lg mt-2" style="color:#73c054;">setor logado x</button><br><br>
                ...
                <button type="button" class="btn btn btn-lg text-light" style="background: #00063f;">
                    <a class="btn btn" href="AreaGestorNotificacao.php" target="_blank" role="button">
                       NOTIFICAÇÃO              
                ...
                <button type="button" class="btn btn btn-lg text-light" style="background: #00063f;">
                    <a class="btn btn" href="AreaGestorComportamento.php" target="_blank">
                        COMPORTAMENTO

                    </a></button><br><br>

                <button type="button" class="btn btn btn-lg text-light" style="background: #00063f;">
                    <a class="btn btn" href="AreaGestorDesempenho.php" target="_blank">
                        DESEMPENHO
                    </a>
                </button><br><br>

                <button type="button" class="btn btn btn-lg text-light" style="background: #00063f;">
                    <a class="btn btn" href="AreaGestorFrequencia.php" target="_blank">
                        FREQUÊNCIA
                    </a>
                </button><br><br>

                <button type="button" class="btn btn btn-lg text-light" style="background: #00063f;">
                    <a class="btn btn" href="AreaGestorPermutas.php" target="_blank">
                        PERMUTA
                    </a>
                </button><br><br>
