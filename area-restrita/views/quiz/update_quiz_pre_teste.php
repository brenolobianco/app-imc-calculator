...
if(isset($_POST['atualizar'])){
    ...
    $update = "UPDATE treinamento_pre_teste SET pergunta = :pergunta, alternativa_a = :alternativa_a, alternativa_b = :alternativa_b, alternativa_c = :alternativa_c, alternativa_d = :alternativa_d, alternativa_e = :alternativa_e, alternativa_correta = :alternativa_correta WHERE id_pre_teste = :id_quiz";
    try{
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card-box">
                        <h2 class="mt-0 mb-3 header-title">Editar Quiz pre-aula</h2>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" value="<?= $alternativa_a ?>" name="alternativa_a" class="form-control" id="inlineFormInputGroup"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" value="<?= $alternativa_b ?>" name="alternativa_b" class="form-control" id="inlineFormInputGroup"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" value="<?= $alternativa_c ?>" name="alternativa_c" class="form-control" id="inlineFormInputGroup"
                                                placeholder="Alternativa">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" value="<?= $alternativa_d ?>" name="alternativa_d" class="form-control" id="inlineFormInputGroup"
                                                placeholder="Alternativa">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-auto">
                                        <div class="input-group mb-2">
                                            ...
                                            <input type="text" value="<?= $alternativa_e ?>" name="alternativa_e" class="form-control" id="inlineFormInputGroup"
                                                placeholder="Alternativa">
                                        </div>
                                    </div>
                                </div>
