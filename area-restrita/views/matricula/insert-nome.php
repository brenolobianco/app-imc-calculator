                ...
                <div class="content">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <?php 
                                include_once 'controllers/academico/ControllerSelect.php';
                                include_once 'controllers/matricula/ControllerInsert-whats.php'; 
                                ?>
                            </div>
                            <div class="col-md-12">
                                <div class="card-box">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-5">
                                                    ...
                                                    <select class="form-control" name="acad_id_mat" required>
                                                        ...
                                                        <option value="<?= $id_acad;?>"><?= $nome_acad;?></option>
