<?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        //$busca_imp_acad  = trim(strip_tags($_POST["busca_imp_acad"]));
        //$busca_mais_acad = trim(strip_tags($_POST["busca_mais_acad"]));

        $insert = "INSERT into academico ( nome_acad, email_acad, senha_acad, 
        cpf_acad, data_nasc_acad, data_cad_acad, periodo_acad, univ_imp_acad, link_cv_lates_acad
        ...
        try{
            ...
            //$result ->bindParam(':busca_imp_acad',$busca_imp_acad, PDO::PARAM_STR);
            //$result ->bindParam(':busca_mais_acad',$busca_mais_acad, PDO::PARAM_STR);
