<?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        $insert = "INSERT into matricula ( insc_mat, whats_mat, acad_id_mat, curso_id_mat, data_cad_mat, est_id_mat, hosp_id_mat  ) 
        VALUES ( :insc_mat, :whats_mat, :acad_id_mat, :curso_id_mat, :data_cad_mat, :est_id_mat, :hosp_id_mat  )";  
        ...
        if($contar>0){
            ...
            header("Refresh: 0, home.php?acao=etapa-1&id_est=$id_est");
        }else{
            echo '<br />
