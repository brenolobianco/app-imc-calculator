...
<?php
    ...
    if(isset($_POST['cadastrar'])){
        ...
        $insert = "INSERT into matricula ( insc_mat, acad_id_mat, curso_id_mat, data_cad_mat, est_id_mat, hosp_id_mat  ) 
        VALUES ( :insc_mat, :acad_id_mat, :curso_id_mat, :data_cad_mat, :est_id_mat, :hosp_id_mat  )";  
