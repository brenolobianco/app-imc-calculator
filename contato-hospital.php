<?php include_once 'includes/headerIndex.php';?>
    <section class="mbr-section form1 cid-spUgZxAgL2" id="form1-5" style="color: #fff;">
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg">
                    <div class="text-wrapper">
                        <h6 class="mar3-per card-title mbr-fonts-style display-2">
                            <strong>A MedHub no seu Hospital.</strong></h6>
                        <p class="mbr-text mbr-fonts-style mb-4 display-7">
                            Oferecemos soluções de Estágio/Pesquisa que podem se adequar às particularidades do seu Hospital. Entre em contato e nós discutiremos as melhores estratégias para implantação na sua instituição de saúde. Lembrando que o nosso Sistema de Convênios é GRATUITO. </p>
                        
                    </div>
                </div>
                <div class="col-12 col-lg-5">
                    <div class="image-wrapper">
                        <img src="assets/images/img-medhub-hosp-653x653.jpg" style="border-radius: 10px;" alt="MedHub">
                    </div>
                </div>
            </div>
        </div>
	   ...
	   <div class="contact-main">
	   	    <div class="contact-bottom">
		   	   <div class="contact-right">
		   	     <form action="processaFormHosp.php" method="post">
