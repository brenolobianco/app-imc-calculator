...
//echo json_encode(array('id'=>'', 'status'=>-1, 'msg'=>$dataTime));
//exit;
//$data = filter_input_array(INPUT_POST, FILTER_DEFAULT);
require_once '../vendor/autoload.php';
MercadoPago\SDK::setAccessToken("TEST-480299382678206-082814-f1960e11180cad3308351dbfe239556b-79914435");
//MercadoPago\SDK::setAccessToken("4879677191931954-101415-36e4df45b739a0972bc05246038e1915-1163641136");
...
$result = $payment->save();
if ($result) {
    $insertPayment = "INSERT into payment ( academicoId, matriculaId, cursoId, price, paymentType, paymentId, token, api, status, createdAt, updatedAt ) 
VALUES ( :academicoId, :matriculaId, :cursoId, :price, :paymentType, :paymentId, :token, :api ,:status, :createdAt, :updatedAt )";
    ...
    $insc_mat = 'Liberado';
        ...
        $resultPayment->bindParam(':paymentType', $payment->status_detail, PDO::PARAM_STR);
        $resultPayment->bindParam(':paymentId', $paymentType, PDO::PARAM_STR);
