<?php include_once 'controllers/matricula/ControllerSelect.php';?>
<section class="header14 cid-tbp7qnWREW" id="header14-y" style="margin-top: -80px;">

<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
        <a href="home.php?acao=perfil&id_acad=<?= $idLog;?>" class="nav-link link btn btn-default mb-4 display-2" style="float: left; margin-left: 40px; margin-top: 0px;">
...
<section class="content11 cid-tbuTtlCPxf" id="content12-1h" style="margin-top: -100px;">
        ...
        <div class="content-wrapper">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-3">
                    ...
                    <option value="<?=$id_mat;?>">Atual: <?=$nome_est;?></option>
                      <?php
                      
                        $select = "SELECT * from matricula m JOIN estagio e ON e.id_est = m.est_id_mat WHERE acad_id_mat = $idLog ORDER BY id_mat DESC";  
