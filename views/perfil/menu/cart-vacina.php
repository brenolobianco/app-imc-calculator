...
<section class="content4 cid-tc0htyQ19O" id="content4-41">
    <div class="row">
        ...
        <div class="col-sm-12">
            <center>
            <img src="assets/images/step-5.png" style="width: 300px; margin-top: -20px">
            <br>
            </center>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2">
                    <strong>Upload Comprovante de Vacinação</strong></h3>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
                ...
                <center>
                  ...
                  <div class="col-sm-12">
                    <form method="post" action="controllers/up/ControllerInsertVa.php" class="form-horizontal" role="form" enctype="multipart/form-data">
                      <div class="form-group">
                        <input type="hidden" name="nome_va" value="Comprovante de Vacinação">
                        <input type="hidden" name="acad_id_va" value="<?= $idLog;?>">
                        <label class="picture" for="picture__input" tabIndex="0">
                          <span class="picture__image"></span>
                        </label>
                        
                        <input type="file" name="arq_va" id="picture__input">
...
const pictureImageTxt = "<img src='assets/images/comprovante-de-vacina.png'>";
