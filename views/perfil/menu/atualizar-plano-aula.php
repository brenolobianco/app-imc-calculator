        ...
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2">
                    <strong>Atualizar Plano de Aula</strong></h3>
            </div>
        </div>
    </div>
</section>
...
<section class="content7 cid-tc0htznwpo" id="content7-42">
    <div class="container">
        <div class="row justify-content-center">
                  ...
                  <div class="col-sm-12">
                    <form method="post" action="controllers/up/ControllerInsertPa-2.php" class="form-horizontal" role="form" enctype="multipart/form-data">
                     <center>
