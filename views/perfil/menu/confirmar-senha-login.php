    ...
    if(isset($_POST['sen'])){
        ...
        if($s == $senhaLog){
            echo '<br><div class="alert alert-success">
                ...
                header("Refresh: 1, home.php?acao=atualizar-login2wsdeDEee2@asdEWSfvg&id_acad=$idLog");
        }else{
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-4">
                <form method="POST">
                  ...
                  <br><br><br>
                  <center>
                  <button type="submit" name="sen" class="btn btn-white display-4" style="width: 300px;">Confirmar</button>
                  </center>
                  </p>
                  <br><br>
                  <br><br>
