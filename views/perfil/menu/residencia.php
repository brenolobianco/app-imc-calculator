...
<section class="content4 cid-tc0htyQ19O" id="content4-41">
    <div class="row">
        ...
        <div class="col-sm-12">
            <center>
            <img src="assets/images/step-3.png" style="width: 300px; margin-top: -20px">
            <br>
            </center>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="title col-md-12 col-lg-10">
                <h3 class="mbr-section-title mbr-fonts-style align-center mb-4 display-2">
                    <strong>Upload Comprovante de Residência</strong></h3>
            </div>
        </div>
    </div>
</section>
...
<section class="content7 cid-tc0htznwpo" id="content7-42">
    <div class="container">
        <div class="row justify-content-center">
                ...
                <center>
                  <div class="col-sm-12">
                    <form method="post" action="controllers/up/ControllerInsertCr.php" class="form-horizontal" role="form" enctype="multipart/form-data">
