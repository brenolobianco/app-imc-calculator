...
<section class="features1 cid-tbuO2OyHXT" id="features2-1f">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-7" style="margin-left: 50px; color: #fff;">
                        <h1 style="font-size: 130px;"><strong style="color: yellow;">PARABÉNS!!!</strong>
                            <h1>
                    ...
                    <div class="col-sm-12" style="margin-left: 50px; color: #fff;">
                        <p class="mbr-text mbr-fonts-style display-7">
                            <strong>Siga os próximos passos clicando em “Documentos”</strong>
                        </p>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-3" style="cursor: pointer;" onclick="document.location.href = 'home.php?acao=frequencia&id_est=<?= $userEst ?>' ">
