            ...
            <div class="container">
              <div class="row">
                <div class="col-sm-7" style="margin-left: 50px; color: #fff;">
                  <h1 style="fotn-size: 130px;"><strong style="color: orange;">QUE PENA…</strong><h1> 
                  <br>
                  <p class="mbr-text mbr-fonts-style display-7"><?= $nomeLog;?>, a sua aprovação ainda não chegou, 
                  mas isso não é motivo para ficar triste. A MedHub está ao seu lado para proporcionar as melhores 
                  oportunidades na Medicina. Fique por dentro de nossa plataforma e redes sociais. Temos confiança 
                  que da próxima vez você atingirá melhores resultados.</p>
                  
                </div>
                <div class="col-sm-4">
                  <img src="assets/images/nao-selo.png">
                </div>
