    ...
    <div class="row justify-content-center">
        <div class="col-lg-12 col-12">
            <center>
                ...
                <h3 style="color: yellow;">CHAVE PIX (E-mail): contato@medhub.app.br</h3>
                <p class="display-4" style="color: #fff;"><br>
                Confirmo que realizei o pagamento via PIX e estou ciente que o mesmo 
                <br>será averiguado pela Equipe MedHub em 24 horas <span style="color: yellow;">APÓS o pagamento</span>.<br><br>
                <a href="home.php?acao=analise" class="btn btn-white display-4" >Sim, eu confirmo!</a>
                </p>
            </center>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form id="form-checkout" action="https://medhub.app.br/payment/mercadopago/src/processPayment.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            <select id="form-checkout__issuer" style="height: 48px" name="issuerId" class="form-control form-control-sm" >
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <select id="form-checkout__identificationType" style="height: 48px" name="identificationType" class="form-control form-control-sm">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <select id="form-checkout__installments" style="height: 48px" name="installments" class="form-control form-control-sm">
                ...
                .then(data => {
                    ...
                    if (data.id){
                        if (data.status==='approved') {
                            $('#msg').html('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">x</button><strong> Pagamento realizado com sucesso!</strong></div>');
                            setTimeout('window.location.href = "https://medhub.app.br/home.php?acao=aprovado"', 500);
                        } else {
                            $('#msg').html('<div class="text-success"><label class="text-warning">Erro ao processar o pagamento:</label> ' + data.status + '</div>');
