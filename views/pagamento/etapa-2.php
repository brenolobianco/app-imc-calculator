            ...
            <div class="col-lg-5 col-12">
                <div class="card mb-3">
                  ...
                  <div class="card-body" style="border-radius: 0px 0px 25px 25px; background-color: #8B0000;">
                    <h5 style="text-align: center; margin-top: 10px; color: #fff;">Quase lá, só mais 2 documento!!!</h5>
                  </div>
                </div>
            </div>
            <div class="col-lg-5 offset-lg-1">
                <form method="post" action="controllers/pagamento/ControllerInsertMa.php" enctype="multipart/form-data">
                    <input type="hidden" name="acad_id_ma" value="<?=$idLog;?>">
                    <div class="col-lg-12 col-md col-sm-12 form-group">
                        <label style="color: #fff;"> Comprovante de Matrícula *</label>
                        <input type="file" name="arq_ma" class="place_form form-control" style="padding-top: 13px; border-radius: 25px;" required/>
                    </div>
